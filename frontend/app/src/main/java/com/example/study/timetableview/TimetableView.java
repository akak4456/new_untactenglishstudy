...
public class TimetableView extends LinearLayout {
    ...
    private void init() {
        ...
        tableBoxScroll = view.findViewById(R.id.table_box_scroll);
        createTable();
    }
    ...
    private void add(final ArrayList<Schedule> schedules, int specIdx) {
        ...
        for (Schedule schedule : schedules) {
            ...
            final int putIdx = idx;
            tv.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(stickerSelectedListener != null)
                        stickerSelectedListener.OnStickerSelected(putIdx, schedules);
                }
            });
    ...
    public void scrollToByY(int y){
        tableBoxScroll.scrollTo(0,y);
    }
