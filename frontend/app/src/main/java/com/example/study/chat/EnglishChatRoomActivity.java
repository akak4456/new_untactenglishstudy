...
public class EnglishChatRoomActivity extends AppCompatActivity {
    ...
    private static final String SOCKET_PUBLIC_SEND_PREFIX = "/pub/send/en/";
    private static final String SOCKET_PUBLIC_HELLO_PREFIX = "/pub/hello/en/";
    private static final String SOCKET_SUBSCRIPTION_PREFIX = "/sub/group/en/";
